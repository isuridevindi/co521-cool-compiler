...
public:
    ...
    // function to get class tags
    std::map<Symbol, int> GetClassTags();

    // function to get class nodes
    std::vector<CgenNode*> GetClassNodes();

    // function to get one class node
...
public:
    ...
    // function to get list of CgenNodes of children
    ...
    // function to emit prototype objects
    void code_protObj(ostream& s);
    // function to initialize a code label
    void code_init(ostream& s);
    // function to emit the codes
...
public:
    ...
    // add 0 as scope length to end of the vector
    void EnterScope() {
        m_scope_lengths.push_back(0);
    }

    // remove items from variable index table
    void ExitScope() {
    ...
    // Get index of a symbol in attribute table
    ...
    // Get index of a symbol in parameter table
